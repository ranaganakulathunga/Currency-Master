...
app.get("/convert", async (req, res) => {
  ...
  const currencyURL = `https://openexchangerates.org/api/historical/${date}.json?app_id=47acda2fe1b8426294328eedc60b7a3d`;
  const namesURl = `https://openexchangerates.org/api/currencies.json?app_id=47acda2fe1b8426294328eedc60b7a3d`;
  try {
