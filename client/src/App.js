...
function App() {
  ...
  return (
    <div>
      <h1 className="lg:mx-32  text-5xl font-black flex items-center justify-normal text-yellow-300">
        Currency Master
      </h1>
      ...
      <div className=" mt-5 flex items-center justify-center flex-col">
        <section className="w-full lg:w-1/2">
          <form onSubmit={getTheTargetAmount}>
            <div className="mb-4">
              <label
                className="block mb-2 text-sm font-medium text-yellow-300 dark:text-white"
                htmlFor="date"
              >
                Date
              </label>
            ...
            <button className="bg-yellow-300 hover:bg-green-700 text-black font-bold py-2 px-4 rounded">
